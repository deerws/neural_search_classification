...
<body>
    ...
    <script>
        ...
        // Função para renderizar a tabela de linhas relacionadas
        function updateRelatedTable() {
            ...
            const relatedRows = allData.filter(row => 
                row['Status'] !== 'Em Análise' && selectedSegments.has(row['Segmento'])
            );
        ...
        // Adiciona evento para atualizar o gráfico e resetar checkboxes quando o formulário for enviado
